...
public class Process implements Comparable {
    ...
    public Process(Process p) {
        ...
        this.time_finished = p.time_finished;
        ...
        this.userIntent = p.userIntent;
        this.totalCpuCyclesExecuted = p.totalCpuCyclesExecuted;
        this.ioBlockCount = p.ioBlockCount;
    ...
    public String toString() {
        ...
        sb.append(" cpu_cycles: ");
        sb.append(totalCpuCyclesExecuted);
        sb.append(" io_blocks: ");
        sb.append(ioBlockCount);
        sb.append("\nPMM:\n");
